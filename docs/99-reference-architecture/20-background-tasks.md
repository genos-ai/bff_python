...
python cli_click.py --action worker --workers 2
...
1. Check worker is running: `python cli_click.py --action worker`
...
1. Check scheduler is running: `python cli_click.py --action scheduler`
